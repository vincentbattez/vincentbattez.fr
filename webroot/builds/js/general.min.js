...
function animate(a,e,o,s){$(a).addClass("animated "+e),setTimeout(function(){switch($(a).removeClass("animated "+e),o){case"remove":$(a).remove();break;case"hide":$(a).hide();break;case"show":$(a).show()}},s)}function showModal(){var a=$(".modal-container"),e=$("aside.modal");$(e).css("display","flex"),$(a).css("display","block"),animate(e,"fadeIn","show","1000"),animate(a,"fadeInDown","show","1000"),$("aside #name").focus(),$(".modal").removeClass("hide"),$(".modal").addClass("show")}function hideModal(){var a=$(".modal-container"),e=$("aside.modal");animate(a,"fadeOutUp","hide","1000"),animate(e,"fadeOut","hide","1000"),$(".modal").removeClass("show"),$(".modal").addClass("hide")}$(function(){var a=1e3;$('a[href*="#"]:not([href="#"])').click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var e=$(this.hash),o=(e=e.length?e:$("[name="+this.hash.slice(1)+"]"))[0].className;if(e.length)return"developpeur realisations"==o?$("html, body").animate({scrollTop:e.offset().top+170},a):$("html, body").animate({scrollTop:e.offset().top-50},a),!1}})});
jQuery(document).ready(function(n){function o(){n("[data-nav-content]").hasClass("open")?n("[data-nav-content]").removeClass("open"):n("[data-nav-content]").addClass("open")}var e=".message-important",t=Math.round(n("section.header").outerHeight()),a=!0;a&&n(window).scroll(function(){n(e).length&&Math.round(n(e).offset().top)>t&&(n(e).css("position","absolute"),a=!1)}),n(e+" .exit").on("click",function(){n(e).length&&n(e).remove()}),setTimeout(function(){animate(".loading","fadeOut","remove","750"),setTimeout(function(){n("header.container").addClass("fadeInUp animated"),n("body").css("overflow-y","auto")},500)},500),n("body").on("click",".modal-open",function(n){n.preventDefault(),showModal()}),n("body").on("click",".modal-exit",function(n){n.preventDefault(),hideModal()}),n(document).keyup(function(o){27==o.keyCode&&n(".modal").hasClass("show")&&(event.preventDefault(),hideModal())});var d=new ScrollMagic.Controller;new ScrollMagic.Scene({triggerElement:"nav",triggerHook:0,duration:0}).setPin("nav").addTo(d),n("[data-dropdown-trigger]").on("click",function(o){o.preventDefault(),n(".dropdown").hasClass("active")?(n(".dropdown-overlay").fadeOut(300),n(".fa-caret-down").css("transform","rotate(0deg)"),n(".dropdown").slideUp("400",function(){n(this).removeClass("active")})):(n(".dropdown-overlay").fadeIn(300),n(".fa-caret-down").css("transform","rotate(180deg)"),n(".dropdown").slideDown("400",function(){n(this).addClass("active")}))}),n("[data-nav-trigger], [data-nav-content] a, [data-nav-content] button").on("click",function(){o()})});